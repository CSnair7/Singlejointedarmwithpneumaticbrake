...
import frc.robot.subsystems.arm.PivotIOTalonFX;
...
public class RobotContainer {
  ...
  private static final Arm arm = new Arm(new CompressorIOPCM(0), new DoubleSolenoidIOPCM(0, 0, 0), new PivotIOTalonFX(0));
